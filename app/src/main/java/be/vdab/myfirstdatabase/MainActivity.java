...
public class MainActivity extends AppCompatActivity
    ...
    private String [] allfaculties = {"Engineering", "Business", "Art"};
...
//        });
    ...
    private void initializeViews(){
        ...
        faculties.setAdapter(new ArrayAdapter<>(MainActivity.this, R.layout.support_simple_spinner_dropdown_item, allfaculties));
    ...
    public void onClick (View view){
        switch (view.getId()){
            case R.id.add_student:
                myDBAdapter.insertStudent(studentName.getText().toString(), faculties.getSelectedItemPosition()+1);
                loadList();
                break;
...
//        }
    ...
    private void loadList(){
        ...
        final ArrayAdapter<String> adapter = new ArrayAdapter<String>(MainActivity.this,R.layout.support_simple_spinner_dropdown_item, allstudents);
